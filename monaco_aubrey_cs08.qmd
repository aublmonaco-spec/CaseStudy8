...
```{r}
ggplot(data = world_new, aes(x = log_gdp, y = lifeExp)) + geom_point(aes(color = continent)) + geom_smooth(method = "lm", se = TRUE, linetype = "dashed", color = "black") + labs(title = "Relationship Between Life Expectancy and Log GDP Per Capita", y = "Life Expectancy (Years)", x = "Log(GDP Per Capita)")
